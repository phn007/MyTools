...
trait ProductDetail {
	...
	function addCategoryLinkIntoProductItem( $productItem ) {
		...
		$pageNumber = 1;
		$productItem['categoryLink'] = $this->getCategoryLink( 'category', $filename, $pageNumber ); //permalink trait
		return $productItem;
	}
	...
	function addBrandLinkIntoProductItem( $productItem ) {
		...
		$pageNumber = 1;
		$productItem['brandLink'] = $this->getCategoryLink( 'brand', $filename, $pageNumber ); //permalink trait
		return $productItem;
	}
