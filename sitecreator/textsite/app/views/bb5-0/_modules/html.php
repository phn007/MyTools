...
trait Components {
	...
	function brandIndexPage() {
		return array(		
			'dir' => 'brandIndex',
			'id' => array( 
				'brandIndex' => 'ClsBrandIndex',
				'catByBrand' => 'ClsCatByBrand',
				'productList' => 'ClsProductByCat',
				'pagination' => 'ClsPagination'
			)
		);
	}
	...
	function shopPage() {
		return array(
			'dir' => 'shop',
			'id' => array( 'categoryGroup' => 'ClsCategoryGroup' )
		);
	}
	...
	function blogPage() {
		return array(
			...
			'id' => array(
				'articleList' => 'ClsArticleList',
				'blogCategoryList' => 'ClsBlogCategoryList',
				'blogPagination' => 'ClsBlogPagination'
			)
		);
	}
}