...
class ClsProductDetail {
	...
	?>
		...
		<div id="brand">Brand: <?php $this->_brand( $brand )?></div>
	...
	?>
		...
		<li class="tab-header-and-content">
			<a href="#" class="is-active tab-link">Product Info</a>
			<div class="tab-content">
				<p><?php echo $description?></p>
			</div>
		</li>
		<li class="tab-header-and-content">
			<a href="#" class="tab-link">Tab1</a>
			<div class="tab-content">
